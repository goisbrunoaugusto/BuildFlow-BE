...
public class PavimentoCreateDTO {

    @NotNull(message = "Área do pavimento é obrigatória")
    ...
    @NotNull(message = "m³ total de argamassa é obrigatório")
    ...
    @NotNull(message = "ID da torre é obrigatório")
