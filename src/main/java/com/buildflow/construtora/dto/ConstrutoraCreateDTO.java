...
public class ConstrutoraCreateDTO {
    ...
    public ConstrutoraCreateDTO() {}

    public ConstrutoraCreateDTO(String nome) {
        this.nome = nome;
    }

    public ConstrutoraCreateDTO(String nome, String cnpj, String endereco, 
